...
eleco = pd.read_csv('ECO_full_hasnr5_dext_jhu.csv')
...
ax.text(14.5, 1.5, 'RESOLVE -A', color = 'red')
...
ax.scatter(ras, decs, s=5, color = 'gray', label='Mass-limited Sample')
...
ax.scatter(ras, decs, s=5, color = 'orange', label='Emission Line Sample')
...
ax.scatter(ras, decs, s=5, color = 'black', label='Strong Emission Line Sample')

#fontP = FontProperties()
#fontP.set_size('small')
lgnd = plt.legend(bbox_to_anchor=(1.01,1), loc="upper left", fontsize = 20,
                  title = 'ECO')
